...
///
/// Deck list (60 cards — 18 Plains + 2 Mox + 2 Sol Ring + 38 spells):
///   18x Plains
///   2x  Mox              (0 mana artifact, +1 fast mana)
...
public static class JundDeckFactory
{
	public static IReadOnlyList<Card> Build(int ownerId)
	{
		...
		AddCopies(deck, ownerId, 4, () => CardLibrary.GetByName("Thoughtseize"));
		...
		AddCopies(deck, ownerId, 2, () => CardLibrary.GetByName("Phyrexian Arena"));
